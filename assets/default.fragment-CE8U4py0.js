import{S as e}from"./index-CtMFCe-8.js";import"./defaultUboDeclaration-CFA2KeQI.js";import"./oitFragment-BS7jAxxB.js";import"./mainUVVaryingDeclaration-vf9T0FNA.js";import"./helperFunctions-y60jlEh9.js";import"./imageProcessingFunctions-B-bI8UI5.js";import"./clipPlaneFragment-Cc41JDem.js";import"./logDepthDeclaration-D0uAHpvG.js";import"./fogFragment-Dp567JMD.js";import"./logDepthFragment-BzvcVYSb.js";import"./meshUboDeclaration-CX6Auw4M.js";const f="lightsFragmentFunctions",i=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
return result;}
fn computeProjectionTextureDiffuseLighting(projectionLightTexture: texture_2d<f32>,projectionLightSampler: sampler,textureProjectionMatrix: mat4x4f,posW: vec3f)->vec3f {var strq: vec4f=textureProjectionMatrix*vec4f(posW,1.0);strq/=strq.w;var textureColor: vec3f=textureSample(projectionLightTexture,projectionLightSampler,strq.xy).rgb;return textureColor;}`;e.IncludesShadersStoreWGSL[f]=i;const a="fresnelFunction",n=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[a]=n;const r="defaultPixelShader",o=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[r]=o;const g={name:r,shader:o};export{g as defaultPixelShaderWGSL};
