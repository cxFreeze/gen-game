import{S as e}from"./index-CtMFCe-8.js";import"./oitFragment-BS7jAxxB.js";import"./harmonicsFunctions-CW-eNvyw.js";import"./mainUVVaryingDeclaration-vf9T0FNA.js";import"./imageProcessingFunctions-B-bI8UI5.js";import"./clipPlaneFragment-Cc41JDem.js";import"./logDepthDeclaration-D0uAHpvG.js";import"./fogFragment-Dp567JMD.js";import"./helperFunctions-y60jlEh9.js";import"./logDepthFragment-BzvcVYSb.js";import"./meshUboDeclaration-CX6Auw4M.js";const a="pbrFragmentExtraDeclaration",n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[l]=d;const s="importanceSampling",E=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDggx(u: vec2f,a: f32)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDCharlie(u: vec2f,a: f32)->vec3f { 
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[s]=E;const m="pbrHelperFunctions",v=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[m]=v;const R="pbrDirectLightingSetupFunctions",u=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
return result;}`;e.IncludesShadersStoreWGSL[R]=u;const S="pbrDirectLightingFalloffFunctions",p=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[S]=p;const C="pbrBRDFFunctions",A=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;e.IncludesShadersStoreWGSL[C]=A;const N="hdrFilteringFunctions",I=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]=I;const O="pbrDirectLightingFunctions",T=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[O]=T;const L="pbrIBLFunctions",h=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[L]=h;const M="pbrBlockAlbedoOpacity",g=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[M]=g;const D="pbrBlockReflectivity",_=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[D]=_;const F="pbrBlockAmbientOcclusion",P=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[F]=P;const U="pbrBlockAlphaFresnel",b=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[U]=b;const G="pbrBlockAnisotropic",B=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[G]=B;const y="pbrBlockReflection",V=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[y]=V;const x="pbrBlockSheen",H=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[x]=H;const W="pbrBlockClearcoat",X=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[W]=X;const k="pbrBlockIridescence",w=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[k]=w;const Y="pbrBlockSubSurface",z=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[Y]=z;const K="pbrBlockNormalGeometric",q=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[K]=q;const $="pbrBlockNormalFinal",Z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[$]=Z;const j="pbrBlockLightmapInit",J=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[j]=J;const Q="pbrBlockGeometryInfo",ee=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[Q]=ee;const re="pbrBlockReflectance0",ie=`var reflectance: f32=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);var specularEnvironmentR0: vec3f=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStoreWGSL[re]=ie;const ae="pbrBlockReflectance",ne=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[ae]=ne;const fe="pbrBlockDirectLighting",te=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStoreWGSL[fe]=te;const oe="pbrBlockFinalLitComponents",ce=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[oe]=ce;const le="pbrBlockFinalUnlitComponents",de=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,vec3f(0.0));finalDiffuse*=uniforms.vLightingIntensity.x;var finalAmbient: vec3f=uniforms.vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;var finalEmissive: vec3f=uniforms.vEmissiveColor;
#ifdef EMISSIVE
...
`;e.IncludesShadersStoreWGSL[le]=de;const se="pbrBlockFinalColorComposition",Ee=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[se]=Ee;const me="pbrBlockImageProcessing",ve=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[me]=ve;const Re="pbrDebug",ue=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[Re]=ue;const r="pbrPixelShader",i=`#define CUSTOM_FRAGMENT_BEGIN
...
`;e.ShadersStoreWGSL[r]=i;const ge={name:r,shader:i};export{ge as pbrPixelShaderWGSL};
