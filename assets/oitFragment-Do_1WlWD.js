import{S as e}from"./index-Bg2hhDhE.js";const t="prePassDeclaration",a=`#ifdef PREPASS
...
#endif
`;e.IncludesShadersStoreWGSL[s]=n;const d="samplerFragmentDeclaration",h=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[d]=h;const l="reflectionFunction",v=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[l]=v;const p="bumpFragmentMainFunctions",c=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[p]=c;const u="bumpFragmentFunctions",m=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[u]=m;const S="bumpFragment",w=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[S]=w;const x="decalFragment",g=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[x]=g;const X="depthPrePass",D=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[X]=D;const L="lightFragment",T=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]=T;const I="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
