import{S as e}from"./index-Cjqptcb2.js";const t="prePassDeclaration",a=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]=f;const s="shadowsFragmentFunctions",n=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[s]=n;const d="samplerFragmentDeclaration",l=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[d]=l;const v="reflectionFunction",h=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[v]=h;const p="imageProcessingDeclaration",u=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[p]=u;const c="imageProcessingFunctions",m=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[c]=m;const S="bumpFragmentMainFunctions",w=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[S]=w;const x="bumpFragmentFunctions",g=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[x]=g;const T="bumpFragment",X=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[T]=X;const D="decalFragment",L=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[D]=L;const C="depthPrePass",I=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[C]=I;const P="lightFragment",y=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]=y;const E="oitFragment",M=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[E]=M;
