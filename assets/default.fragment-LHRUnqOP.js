import{S as e}from"./index-Bg2hhDhE.js";import"./oitFragment-DYapu-RA.js";import"./defaultUboDeclaration-DN579ypC.js";import"./mainUVVaryingDeclaration-CqZp_N-q.js";import"./helperFunctions-DGpH9-hz.js";import"./imageProcessingFunctions-CV1Uqxu_.js";import"./logDepthDeclaration-B4QpYAW9.js";import"./fogFragment-DdqLqliA.js";import"./logDepthFragment-t9PJy6Wq.js";import"./meshUboDeclaration-eEf6B2E3.js";const r="defaultFragmentDeclaration",f=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;
#ifdef SPECULARTERM
...
`;e.IncludesShadersStore[r]=f;const n="lightsFragmentFunctions",l=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#define inline
vec3 computeProjectionTextureDiffuseLighting(sampler2D projectionLightSampler,mat4 textureProjectionMatrix,vec3 posW){vec4 strq=textureProjectionMatrix*vec4(posW,1.0);strq/=strq.w;vec3 textureColor=texture2D(projectionLightSampler,strq.xy).rgb;return textureColor;}`;e.IncludesShadersStore[n]=l;const t="fresnelFunction",a=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[t]=a;const i="defaultPixelShader",o=`#include<__decl__defaultFragment>
...
`;e.ShadersStore[i]=o;const g={name:i,shader:o};export{g as defaultPixelShader};
