import{S as e}from"./index-Bg2hhDhE.js";import"./oitFragment-DYapu-RA.js";import"./harmonicsFunctions-ROnW-1rQ.js";import"./mainUVVaryingDeclaration-CqZp_N-q.js";import"./imageProcessingFunctions-CV1Uqxu_.js";import"./logDepthDeclaration-B4QpYAW9.js";import"./fogFragment-DdqLqliA.js";import"./helperFunctions-DGpH9-hz.js";import"./logDepthFragment-t9PJy6Wq.js";import"./meshUboDeclaration-eEf6B2E3.js";const a="pbrFragmentDeclaration",o=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[a]=o;const t="pbrFragmentExtraDeclaration",r=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[t]=r;const f="samplerFragmentAlternateDeclaration",c=`#ifdef _DEFINENAME_
...
{return diffusionProfile<1.;}`;e.IncludesShadersStore[s]=E;const R="importanceSampling",C=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[R]=C;const u="pbrHelperFunctions",m=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[u]=m;const A="pbrDirectLightingSetupFunctions",v=`struct preLightingInfo
...
#endif
return result;}`;e.IncludesShadersStore[A]=v;const S="pbrDirectLightingFalloffFunctions",I=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[S]=I;const N="pbrBRDFFunctions",T=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;e.IncludesShadersStore[N]=T;const O="hdrFilteringFunctions",p=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[O]=p;const L="pbrDirectLightingFunctions",g=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;e.IncludesShadersStore[L]=g;const M="pbrIBLFunctions",h=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[M]=h;const _="pbrBlockAlbedoOpacity",D=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[_]=D;const F="pbrBlockReflectivity",P=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[F]=P;const b="pbrBlockAmbientOcclusion",U=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[b]=U;const B="pbrBlockAlphaFresnel",G=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[B]=G;const y="pbrBlockAnisotropic",V=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[y]=V;const H="pbrBlockReflection",x=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[H]=x;const X="pbrBlockSheen",W=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[X]=W;const k="pbrBlockClearcoat",Y=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[k]=Y;const w="pbrBlockIridescence",z=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[w]=z;const K="pbrBlockSubSurface",q=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[K]=q;const $="pbrBlockNormalGeometric",Z=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[$]=Z;const J="pbrBlockNormalFinal",j=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[J]=j;const Q="pbrBlockLightmapInit",ee=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[Q]=ee;const ie="pbrBlockGeometryInfo",ne=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[ie]=ne;const ae="pbrBlockReflectance0",oe=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[ae]=oe;const te="pbrBlockReflectance",re=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[te]=re;const fe="pbrBlockDirectLighting",ce=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStore[fe]=ce;const le="pbrBlockFinalLitComponents",de=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;e.IncludesShadersStore[le]=de;const se="pbrBlockFinalUnlitComponents",Ee=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,0.0);finalDiffuse*=vLightingIntensity.x;vec3 finalAmbient=vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;vec3 finalEmissive=vEmissiveColor;
#ifdef EMISSIVE
...
`;e.IncludesShadersStore[se]=Ee;const Re="pbrBlockFinalColorComposition",Ce=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[Re]=Ce;const ue="pbrBlockImageProcessing",me=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[ue]=me;const Ae="pbrDebug",ve=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Ae]=ve;const i="pbrPixelShader",n=`#if defined(BUMP) || !defined(NORMAL) || defined(FORCENORMALFORWARD) || defined(SPECULARAA) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
`;e.ShadersStore[i]=n;const _e={name:i,shader:n};export{_e as pbrPixelShader};
