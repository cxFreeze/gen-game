import { ZoneType } from '../world/world-types';
...
export class Params {
    ...
    // WORLD
    static readonly chunkSize = 500;
    static readonly biomeChunkSize = 2 * this.chunkSize;
    static readonly worldSize = Params.halfWorldSizeChunks * 2 * this.chunkSize; // EVEN NUMBER
    static readonly safeDrawWorldSize = Params.worldSize - Params.chunkSize - 30;
