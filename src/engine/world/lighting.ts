...
export class LightingManager {
    ...
    public createLightning() {
        const ambiantLight = new HemisphericLight('ambiantLight', new Vector3(0, 10, 0), GameRuntime.scene);
        ambiantLight.intensity = 0.7;

        const sun = new DirectionalLight('sun', new Vector3(0.5, -1, 0.5), GameRuntime.scene);
